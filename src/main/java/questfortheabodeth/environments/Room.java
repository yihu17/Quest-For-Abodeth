...
public class Room implements Drawable {
    ...
    public Room(int type, boolean up, boolean down, boolean left, boolean right) {
        ...
        if (up) {
            ...
            roomImages[1][topDoorStart] = new Environment(Settings.ROOM_DIVISION_SIZE * topDoorStart, Settings.ROOM_DIVISION_SIZE, "res/assets/environment/floor/floor1.png", false, false);
            roomImages[1][topDoorStart + 1] = new Environment(Settings.ROOM_DIVISION_SIZE + (topDoorStart + 1), Settings.ROOM_DIVISION_SIZE, "res/assets/environment/floor/floor1.png", false, false);
        } if (down) {
            ...
            roomImages[rightDoorStart][Settings.ROOM_DIVISION_COLUMNS - 1] = new Door(Settings.ROOM_DIVISION_SIZE * Settings.ROOM_DIVISION_COLUMNS, Settings.ROOM_DIVISION_SIZE * rightDoorStart, "res/assets/environment/door1.png", -3);
            roomImages[rightDoorStart + 1][Settings.ROOM_DIVISION_COLUMNS - 1] = new Door(Settings.ROOM_DIVISION_SIZE * Settings.ROOM_DIVISION_COLUMNS, Settings.ROOM_DIVISION_SIZE * (rightDoorStart + 1), "res/assets/environment/door1.png", -3);
